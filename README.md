...
The more difficult case is when you expected the variable to exist in the scope
...
To get a better sense of the various pieces of information provided in the error
